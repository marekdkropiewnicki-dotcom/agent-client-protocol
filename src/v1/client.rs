...
mod tests {
    use super::*;
    use crate::{TextContent, ToolCallUpdateFields};
    ...
    // Lock the wire names down so a rename surfaces as a test failure
    // instead of a silently-misrouted call.
    ...
    fn test_agent_request_ext_method_is_returned_verbatim() {
        ...
        // hand them back unchanged. Routing normalization or rewriting
        // here would silently break every extension that depends on
        // exact-match dispatch on the agent side.
