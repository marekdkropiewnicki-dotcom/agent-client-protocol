...
use crate::validation::{
    Validate, ValidationError, validate_auth_method_id, validate_env_var_name, 
    validate_optional_string_field, validate_string_field, validate_unique_ids,
    validate_url, StringConstraints
};
use super::{AuthenticateRequest, AuthMethod, AuthMethodAgent, AuthMethodId};

#[cfg(feature = "unstable_auth_methods")]
use super::{AuthMethodEnvVar, AuthEnvVar};

#[cfg(feature = "unstable_elicitation")]
use super::{CreateElicitationRequest, ElicitationId, ElicitationFormMode, ElicitationUrlMode};
    ...
    fn validate(&self) -> Result<(), ValidationError> {
        match self {
            ...
            AuthMethod::Terminal(terminal) => {
                ...
                validate_optional_string_field(&terminal.description, "description", &description_constraints)?;
...
impl Validate for CreateElicitationRequest {
    fn validate(&self) -> Result<(), ValidationError> {
        ...
        match &self.mode {
            #[cfg(feature = "unstable_elicitation")]
            crate::v1::ElicitationMode::Form(form) => form.validate()?,
            #[cfg(feature = "unstable_elicitation")]
            crate::v1::ElicitationMode::Url(url) => url.validate()?,
        }
...
mod tests {
    ...
    fn test_elicitation_url_mode_validation() {
        use crate::v1::{ElicitationSessionScope, ElicitationScope};
