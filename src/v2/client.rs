...
#[cfg(test)]
mod tests {
    use super::super::{TextContent, ToolCallUpdateFields};
    use super::*;
    ...
    // Mirror of the v1 client method-routing coverage. Both protocol
    // surfaces must expose the same stable wire method names — any drift
    // between v1 and v2 here would silently break v1<->v2 conversions
    // in `src/v2/conversion.rs`.
